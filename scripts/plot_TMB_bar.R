...
#' 
#' @param melted_data = dataframe with three columns including 'pair_id', 'variable', and 'value' (ex. Tumor_Normal_pair_01, TMB (mut/Mb), 1.4)
#' 
#' @param pair_order = the pair order used to align the genomic and clinical data in the comut plot
#'

plot_TMB_bar <- function(melted_data, pair_order, variables_to_plot){
